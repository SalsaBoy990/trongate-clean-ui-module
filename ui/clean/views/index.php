            ...
            <div id="search-results">
                <template x-for="item in results">
                    <div class="box round border border-default">
                        <b>
                            <a :href="'<?= BASE_URL ?>' + 'entry/' + item.url_string" x-html="item.title"></a>
                        </b>
        ...
        <div class="accordion" x-data="accordionData">
            ...
            <div id="accordionThree" :aria-expanded="isAccordionContentExpanded('accordionThree')"
                ...
                <div class="box">
                    ...
                    <img src="ui-clean_module/images/img_snowtops.jpg"
...
&lt;/div&gt;</code></pre>
        ...
        <div class="card card-4 content-600">
            ...
            <div class="box round-bottom">
                ...
                <img src="ui-clean_module/images/img_snowtops.jpg" alt="Car">
                <p>French Alps</p>
            </div>
        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="row-padding">
            <div class="half">
                ...
                <div class="margin-bottom-1">
                    <label for="logo">Select logo<span class="text-red">*</span></label>
                    <input type="file" class="form-control-file" id="logo"
                           name="logo">
                </div>

                <div class="margin-bottom-1">
                    <label for="gallery">Upload images for the gallery</label>
        ...
        <div class="row-padding">
            <div class="col m3 s4">
                <img src="ui-clean_module/images/img_lights.jpg" class="round"
                     alt="Northern Lights">
            </div>
            <div class="col m3 s4">
                <img src="ui-clean_module/images/img_forest.jpg" class="circle" alt="Forest">
            </div>
            <div class="col m3 s4">
                <img src="ui-clean_module/images/img_mountains.jpg" class="hover-opacity border"
                     alt="Mountains">
            </div>
            <div class="col m3 hide-mobile">
                <div class="relative">
                    <img src="ui-clean_module/images/img_nature.jpg" alt="Nature"
                         class="card card-4">
        ...
        <div x-data="lightboxData">
            <div x-show="openLighbox" class="gallery-modal black" :class="{'show': openLighbox }">
                ...
                <div class="modal-content content-1024">
                    ...
                    <div class="content-960 margin-left-right-auto">
                        <img class="lightbox-item" src="ui-clean_module/images/img_nature_wide.jpg"
                             alt="Nature">
                        <img class="lightbox-item" src="ui-clean_module/images/img_snow_wide.jpg"
                             alt="Snow">
                        <img class="lightbox-item" src="ui-clean_module/images/img_mountains_wide.jpg"
                             alt="Mountains">
                        <div class="row black center">
                            ...
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="ui-clean_module/images/img_nature_wide.jpg"
                                     @click="currentLightbox(1)" alt="Nature and sunrise">
                            </div>
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="ui-clean_module/images/img_snow_wide.jpg"
                                     @click="currentLightbox(2)" alt="French Alps">
                            </div>
                            <div class="col s4">
                                <img class="lightbox-dots opacity hover-opacity-off pointer"
                                     src="ui-clean_module/images/img_mountains_wide.jpg"
            ...
            <div class="row-padding">
                <div class="col s4">
                    <img src="ui-clean_module/images/img_nature_wide.jpg"
                         @click="openLightbox();currentLightbox(1)" class="hover-shadow pointer" alt="Nature">
                </div>
                <div class="col s4">
                    <img src="ui-clean_module/images/img_snow_wide.jpg"
                         @click="openLightbox();currentLightbox(2)" class="hover-shadow pointer" alt="Snow">
                </div>
                <div class="col s4">
                    <img src="ui-clean_module/images/img_mountains_wide.jpg"
        ...
        <div x-data="modalData">
            <img class="hover-opacity thumbnail-third pointer"
                 role="button"
                 src="ui-clean_module/images/img_nature.jpg"
                 alt="Nature"
                 @click="openModal()">
        ...
        <div class="card relative padding-1 hover-gray-20 ">
            <img src="ui-clean_module/images/img_avatar2.png"
        ...
        <ul class="card card-4">
            ...
            <li class="hover-gray-20 relative">
                <img src="ui-clean_module/images/img_avatar5.png"
            ...
            <li class="hover-gray-20 relative">
                <img src="ui-clean_module/images/img_avatar6.png"
            ...
            <li class="hover-gray-20 relative">
                <img src="ui-clean_module/images/img_avatar3.png"
        ...
        <div x-data="sliderData" x-init="slideItemClass = 'slide-item'; slideDotsClass = 'slide-dots';"
            ...
            <div class="relative slide-item">
                <img src="ui-clean_module/images/img_nature_wide.jpg" alt="Beautiful Nature">
            ...
            <div class="relative slide-item">
                <img src="ui-clean_module/images/img_snow_wide.jpg" alt="French Alps">
                ...
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Snow');">
                        <img src="ui-clean_module/images/img_snowtops.jpg" alt="Fjords">
                    </a>
                </div>
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Mountains');">
                        <img src="ui-clean_module/images/img_mountains.jpg" alt="Mountains">
                    </a>
                </div>
                <div class="col s3 box">
                    <a href="javascript:void(0)" class="hover-opacity tabbed-image-gallery-button"
                       @click="openTabbedImage('Lights');">
                        <img src="ui-clean_module/images/img_lights.jpg" alt="Lights">
                    </a>
                </div>
            </div>
        ...
        <video controls title="Test Video">
            <source src="ui-clean_module/vids/GNOME-Workspace-Switch.mp4" type="video/mp4">
        ...
        <div class="row-padding">
            ...
            <div class="half">
                ...
                <div class="relative green">
                    <img src="ui-clean_module/images/img_lights.jpg" alt="Lights" class="thumbnail">
                    <div class="topleft padding-1">Top Left</div>
                    <div class="topright padding-1">Top Right</div>
                    <div class="bottomleft padding-1">Bottom Left</div>
                    <div class="bottomright padding-1">Bottom Right</div>
        ...
        <div class="row-padding center">
            ...
            <div class="col m3 hide-mobile">
                <img src="ui-clean_module/images/img_workshop.jpg" alt="Workshop">
                <div class="red box">
                    <p>Normal</p>
                </div>
            </div>
